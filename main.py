...
SEARCH_BY_KEY_WORD = '甜點'
SAVE_DATA_DIR_PATH = './dat/{}/'.format(SEARCH_BY_KEY_WORD)
PROCESSED_DAT_PATH = './dat/PROCESSED.txt'
LOG_DATA_FILE_PATH = './LOG.txt'
    ...
    try:
        ...
        while True:
            for anchor in anchors:
                ...
                if info['name'] in processed_names: continue
